...
BEST_MODEL_PATH = MODEL_DIR / "carnet_v3_30_best.pth"
REPORT_PATH = OUTPUT_DIR / "carnet_v3_classification_report.txt"
CURVE_PATH = FIGURE_DIR / "carnet_v3_training_curves.png"
...
def prepare_dataloaders():
    ...
    val_size = int(len(train_samples_all) * VAL_RATIO)
...
class CarNet(nn.Module):
    ...
    CarNet v2'ye göre farkları:
    1. Global Average Pooling + Global Max Pooling birlikte kullanıldı.
    2. Son convolution feature map üzerinde Spatial Dropout eklendi.
    3. Classifier girişi 384 yerine 768 oldu.
    4. Daha fazla gerçek eğitim verisi için validation oranı %10'a düşürüldü.
    """
    def __init__(self, num_classes):
        ...
        self.spatial_dropout = nn.Dropout2d(p=0.10)
